...
>
> **File:** `Section 4 Entry Trigger and Price Memory v10.1 (One-Paste + Ranked Panel).pine` — renamed 2 Sep 2026 to match the in-file title, which stays the authoritative version (`shorttitle "S4 Entry v10.1"`). Bump both together. · **Type:** Indicator (overlay) · **Pine:** v6 · **Library:** `import jayramg/S4Core/23` (published) · **Market:** NSE · **Applies on:** the **75/125-min trading chart**.
>
