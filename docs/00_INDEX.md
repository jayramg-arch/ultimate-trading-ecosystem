...
> **Last updated: 9 June 2026** — *Pine panel pass: Wyckoff catalysts surfaced on the Unified panel; honest "no active setup" trade levels on the Bull & Recovery screeners; **Risk Allocator v1.1 — catalyst + regime aware targets/trail** synced to Unified v3.4.*
...
| 10 | [Risk Allocator v1.1](./10_Risk_Allocator_v1_Guide.md) | `Commander_Risk_Allocator_v1.0.pine` (title v1.1) | Pine | Discretionary chart-click sizing — Kelly sizing, Telegram alerts. **v1.1 (9 Jun):** catalyst+regime aware targets/trail synced to Unified v3.4 (POS/WYC 5R/10R · SWG 3R/5R · GAP/REV-swing 2R · recovery REV 5R/52wH; trail POS 4.5/WYC 3.5/REV 2.5/SWG 1.5 ×ATR, +0.5 bear). T1 click now optional override. |
