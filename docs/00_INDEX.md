...
> — the web portal for these guides. **Twelve of 24** are published as pages — the whole of Doctrine &
> Process, Evidence & Measurement, and The Live System: the Commander Bible · 07 Mission
> Control · 08 Swing Pro Dashboard · 16 Honesty Layer · 18 Trade Funnel · 19 Performance
> Ledger · 22 Section Four · 23 Golden Matcher · 24 Pre-Trade Gate · 25 Golden Rules ·
> 26 Operating Loop · 27 Backtest Court. The rest are listed there with a **Markdown**
> status and are being brought across in library order. HTML sources live in
> `docs/portal/`.
