...
> — the web portal for these guides. **Eight** are published as pages so far (the Trading
> Bible · 16 Honesty Layer · 18 Trade Funnel · 19 Performance Ledger · 24 Pre-Trade Gate ·
> 25 Golden Rules · 26 Operating Loop · 27 Backtest Court); the rest are listed there with a
> **Markdown** status and are being brought across in library order. HTML sources live in
> `docs/portal/`.
