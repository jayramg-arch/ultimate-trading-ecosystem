...
# 2. INPUTS
print("\n" + "="*50)
print("🛡️ FOREVER ORDER MANAGER (v2.0 PATCHED)")
print("="*50)
...
try:
    # CORRECTION: The library expects 'trigger_Price' (Capital P)
    response = dhan.place_forever(
        ...
        # LEG 1: TARGET (Profit)
        price=target_price,
        trigger_Price=target_price,   # <--- THE FIX (Capital P)
        
        # LEG 2: STOP LOSS (OCO)
        order_flag="OCO",
        price1=stop_price * 0.99,     # Stop Limit (1% slip protection)
